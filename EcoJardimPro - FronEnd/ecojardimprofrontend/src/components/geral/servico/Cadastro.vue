                                        ...
                                        <v-card-text class="mt-2">
                                            <v-row dense>
                                                <v-col cols="12" sm="12" md="4" lg="4">
                                                    <v-select color="#4CAF50" v-model="item.orcamentoId" label="Orçamentos"
                                                ...
                                                <v-col cols="12" sm="12" md="4" lg="4">
                                                    <v-text-field type="number" color="#4CAF50" v-model="item.valor" label="Valor do Serviço"
