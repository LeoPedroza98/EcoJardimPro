<template>
  <master-page titulo="Orçamentos" icone="mdi-account-cash">
...
export default class ListaProjetos extends PageBase {
  ...
  Atualizar(isFiltro: boolean = false) {
    ...
    this.service.Listar(page, itemsPerPage, sortBy, sortDesc, this.search, this.header,undefined, 'Projeto.Status').then(
      res => {
