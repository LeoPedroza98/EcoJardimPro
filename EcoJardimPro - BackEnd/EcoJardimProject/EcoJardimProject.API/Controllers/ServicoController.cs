...
public class ServicoController : MasterCrudController<Servico>
{
  ...
  public ServicoController(ILogger<MasterCrudController<Servico>> logger, IServicoService service, string includePatch = "Status,Orcamentos") : base(logger, service, includePatch)
  {
    _service = service;
  }
}