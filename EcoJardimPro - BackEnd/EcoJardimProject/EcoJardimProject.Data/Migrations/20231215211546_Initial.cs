        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcessoHabilitado = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Endereco_Numero = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    Endereco_Complemento = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Endereco_Cep = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    Endereco_Bairro = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Endereco_Municipio = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Contato_Nome = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Contato_Telefone = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    Contato_Celular = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    Contato_Email = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orcamentos_Projetos_ProjetoId",
